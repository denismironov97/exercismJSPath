...
export function canExecuteFastAttack(knightIsAwake) {
  const isFastAttackPossible = !knightIsAwake;

  return isFastAttackPossible;
}
...
export function canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake) {
  const isSPyUseful = knightIsAwake || archerIsAwake || prisonerIsAwake;
